...
#define EEPROM_START                  (void*)(uintptr_t)(EEPROM_STORAGE_SPACE_START + 50)
#define EEPROM_START_C1               (void*)(uintptr_t)EEPROM_START
#define EEPROM_START_C2               (void*)(uintptr_t)(EEPROM_START + 1)
#define EEPROM_TOP_START              (void*)(uintptr_t)(EEPROM_START + 2)
