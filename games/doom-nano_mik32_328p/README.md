Это программа, преобразованная для работы с использованием библиотек Arduboy и целочисленных вычислений (на AVR можно без них, но на MIK32 Amur с float работает медленно)
