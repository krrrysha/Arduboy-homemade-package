# 1. О проекте
Данный проект является ответвлением от Arduboy-homemade-package, развиваемого пользователем MrBlinky и основанного на библиотеке Arduboy2  пользователя MLXXXp. В развиитии Arduboy участвовали многие люди, во время разработки изучался опыт пользователя harbaum. 
